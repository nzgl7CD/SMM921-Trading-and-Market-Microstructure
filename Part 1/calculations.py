...
class Calculations:
    ...
    def set_quote_spread(self):
        ...
        self.dataset['Mid Quote Return'] = self.dataset['Mid Quote'].pct_change() ###Mid Quote Return as (mq1-mq0)/mq0 from index 1 to n as we don't calculate return for the first value
